package filestorageapi.controller;

import filestorageapi.props.FileStorageProperties;
...
public class FileStorageController {
    ...
    public FileStorageController(FileStorageProperties fileProps) {
        this.fileStorageLocation = Paths.get(fileProps.getUploadDir())
